...
{	
	...
	vppif_reg32_write(0xd8110024,0x7,0,0x7);		// GPIO0 gpio enable
	vppif_reg32_write(0xd8110054,0x7,0,0x7);		// GPIO0 output mode
	vppif_reg32_write(0xd8110084,0x7,0,0x0);		// GPIO0 output mode
	vppif_reg32_write(0xd8110640,0x707,0,0x707);	// GPIO0 pull enable
		
	vppif_reg32_write(0xd8110084,0x2,1,0x1);		// VGL lo
	mdelay(8);										// delay 5ms
	vppif_reg32_write(0xd8110084,0x1,0,0x1);		// AVDD hi
	mdelay(6);										// delay 5ms
	vppif_reg32_write(0xd8110084,0x4,2,0x1);		// VGH hi
...
#if(WMT_CUR_PID == WMT_PID_8425)
	mdelay(10);										// delay 10ms
	vppif_reg32_write(0xd8110084,0x4,2,0x0);		// VGH lo
	mdelay(6);										// delay 5ms
	vppif_reg32_write(0xd8110084,0x1,0,0x0);		// AVDD lo
	mdelay(8);										// delay 5ms
	vppif_reg32_write(0xd8110084,0x2,1,0x0);		// VGL lo
#endif
}
