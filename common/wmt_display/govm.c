...
void govm_init(void *base)
{
	...
	govm_set_vpu_coordinate(0,0,vfb_var.xres,vfb_var.yres);
...
void govm_pip_init(void *base)
{
	...
	govm_set_pip_coordinate(0,0,vfb_var.xres-1,vfb_var.yres-1);
...
#ifdef WMT_FTBLK_PIP
{
	...
	pip_mod_p->resx_visual = vfb_var.xres;
	pip_mod_p->resy_visual = vfb_var.yres;
