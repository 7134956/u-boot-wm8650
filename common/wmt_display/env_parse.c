...
int parse_display_params(char *name)
{
	...
	g_display_param.vout = ps[0];
	g_display_param.op1 = ps[1];
	g_display_param.op2 = ps[2];
	g_display_param.resx = ps[3];
	g_display_param.resy = ps[4];
	g_display_param.fps_pixclk = ps[5];
