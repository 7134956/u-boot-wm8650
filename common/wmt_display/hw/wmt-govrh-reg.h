...
#define GOVRH_DVO_BLANK_DATA		REG_GOVRH_DVO_BLANK_DATA,0x3FFFFFFF
...
#define GOVRH_DVO_BLK_DIS			REG_GOVRH_DVO_SET,BIT16,16
#define GOVRH_RGB_SWAP				REG_GOVRH_DVO_SET,0x300,8
