...
int govw_mod_init(void)
{
	...
	if( !mod_p ){
		printf("*E* GOVW module register fail\n");
		return -1;
	}
	...
	mod_fb_p->capability = BIT(VDO_COL_FMT_YUV422H) | BIT(VDO_COL_FMT_YUV444) | BIT(VDO_COL_FMT_ARGB) | VPP_FB_FLAG_CSC
						| BIT(VDO_COL_FMT_RGB_1555) | BIT(VDO_COL_FMT_RGB_666) | BIT(VDO_COL_FMT_RGB_565);
